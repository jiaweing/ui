...
```bash
npx shadcn@latest add "https://ui.jiaweing.com/r/styles/new-york-v4/input-group.json"
```
  ...
  return (
    <InputGroup>
      <TextareaAutosize
        ...
        className="dark:bg-input/30 field-sizing-content flex min-h-16 w-full resize-none rounded-md bg-transparent px-3 py-2 text-base outline-none transition-[color,box-shadow]"
...
Add the `min-w-0` class to the `InputGroup` component. See [diff](https://github.com/jiaweing-ui/ui/pull/8341/files#diff-0e2ee95d0050ca4c5d82339df86c54e14a6739dc4638fdda0eec8f73aebc2da9).
