...
```bash
npx shadcn@latest add "https://ui.jiaweing.com/r/styles/new-york-v4/sidebar.json"
```
...
- [#5593](https://github.com/jiaweing-ui/ui/pull/5593) - Improved setOpen callback logic in `<SidebarProvider>`.
...
- [#5491](https://github.com/jiaweing-ui/ui/pull/5491) - Moved `text-sidebar-foreground` from `<SidebarProvider>` to `<Sidebar>` component.
