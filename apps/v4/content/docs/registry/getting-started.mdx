...
If you're starting a new registry project, you can use the [registry template](https://github.com/jiaweing-ui/registry-template) as a starting point. We have already configured it for you.
...
If you'd like to see an example of a registry, we have a [template project](https://github.com/jiaweing-ui/registry-template) for you to use as a starting point.
