...
You can open an issue to add a registry to the index by filling out the [registry directory issue template](https://github.com/jiaweing-ui/ui/issues/new?template=registry_directory.yml).
