...
**Note:** We're working on upgrading to Recharts v3. In the meantime, if you'd like to start testing v3, see the code in the comment [here](https://github.com/jiaweing-ui/ui/issues/7669#issuecomment-2998299159). We'll have an official release soon.
...
```bash
npx shadcn@latest add "https://ui.jiaweing.com/r/styles/new-york-v4/chart.json"
```
