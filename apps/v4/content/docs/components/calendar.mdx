...
```bash
npx shadcn@latest add "https://ui.jiaweing.com/r/styles/new-york-v4/calendar.json"
```
...
```bash
npx shadcn@latest add "https://ui.jiaweing.com/r/styles/new-york-v4/calendar-02.json"
```
